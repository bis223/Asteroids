...
//Bullet object is being pooled. Member variables are initiaized/re-initialised at the time of activation
Bullet::Bullet() 
{
}
...
void Bullet::Initialise(int type, const D3DXVECTOR3 &position, const D3DXVECTOR3 &direction)
{
	...
	shooterType_ = static_cast<ShooterType>(type);
}
